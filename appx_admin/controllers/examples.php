...
class Admin extends CI_Controller {
	...
	function test()
	{
			...
			$crud->set_subject('Novosti');
			
        		$crud->required_fields('news_name_sr','news_name_ci');
			 
			$crud->columns('datum','image','news_name_sr','news_name_ci','news_name_hu');
			
			$crud->display_as('image','Slika')->display_as('news_name_sr','Naslov (lat)')->display_as('news_name_ci','Naslov (cir)')->display_as('news_name_hu','Naslov (hu)');
			
			$crud->order_by('datum','asc');
			...
			$this->load->view('gallery/list.php',$data);
