...
class CI_Image_lib {
	...
	function image_process_gd($action = 'resize')
	{
		...
		imageFill($dst_img, $this->width, 0, imageColorAllocate($dst_img,255,255,255) );
		imageFill($dst_img, 0, $this->height, imageColorAllocate($dst_img,255,255,255) );
		imageFill($dst_img, $this->width, $this->height, imageColorAllocate($dst_img,255,255,255) );
		/*******************************BOBAN**************************************/
